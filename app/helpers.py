...
def lat_log(accept_type, address, sensor='false'):
    """Access the Google Geocoding API to return lat and lon given an address.

    :param address: url encoded address string
    :param accept_type: json or xml
    ...
    resp = requests.get(geo_uri + accept_type, params=params)
    ...
    elif decoded_resp['REQUEST_DENIED']:
